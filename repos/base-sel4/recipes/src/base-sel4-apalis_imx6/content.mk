...
enable_board_spec: etc/specs.conf
	echo "SPECS += apalis_imx6" >> etc/specs.conf
...
content: README
README:
	cp $(REP_DIR)/recipes/src/base-sel4-apalis_imx6/README $@
...
content:
	...
	sed -i "s/apalis_imx6_timer_drv/timer/" src/timer/epit/apalis_imx6/target.inc
