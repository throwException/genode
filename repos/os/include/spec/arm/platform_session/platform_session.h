...
struct Platform::Session : Genode::Session
{
	...
	using String = Genode::Rpc_in_buffer<Device::DEVICE_NAME_LEN>;
	 ...
	 */
	virtual Genode::Rom_session_capability devices_rom() = 0;
	 ...
	 */
	virtual Genode::addr_t bus_addr_dma_buffer(Genode::Ram_dataspace_capability) = 0;
	...
	GENODE_RPC(Rpc_devices_rom, Genode::Rom_session_capability,
	           devices_rom);
	...
	GENODE_RPC_THROW(Rpc_alloc_dma_buffer, Genode::Ram_dataspace_capability,
	                 alloc_dma_buffer,
	                 GENODE_TYPE_LIST(Genode::Out_of_ram, Genode::Out_of_caps, Fatal),
	                 Genode::size_t);
	GENODE_RPC(Rpc_free_dma_buffer, void, free_dma_buffer,
	           Genode::Ram_dataspace_capability);
	GENODE_RPC(Rpc_bus_addr_dma_buffer, Genode::addr_t, bus_addr_dma_buffer,
	           Genode::Ram_dataspace_capability);
